...
def Plot_Network(Network , Network_data , congestions , min_cong , max_cong , cmap):
...
def Compute_Strategy_vectors(OD_demands, Freeflowtimes, Networkx, Edges, num_routes = 5, multipl_factor = 3):
